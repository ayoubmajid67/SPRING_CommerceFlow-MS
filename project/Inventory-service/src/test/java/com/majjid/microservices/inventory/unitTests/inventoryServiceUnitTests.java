...
import com.majjid.microservices.inventory.Dto.inventory.PurchaseDto;
import com.majjid.microservices.inventory.Dto.inventory.SellDto;
...
class inventoryServiceUnitTests {
    ...
    private static final Logger log = LoggerFactory.getLogger(inventoryServiceUnitTests.class);
